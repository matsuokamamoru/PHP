...
class DetailController extends AbstractWebController
{
	...
	public function indexAction()
	{
		...
		$response['gaSendPageView'] = "sp/コンテンツ/{$this->genreList[$response['contents'][0]['genre_id']]}/$contentId";
	...
	public function newAction()
	{
		...
		$response['gaSendPageView'] = "sp/コンテンツ/新着";

		$this->templatePath = 'sp/detail/index.tpl';
		$this->view->assignByRef('form', $response);
	}
