...
<h2 class="title_archive">デイリーアクセスランキング</h2>

<section id="ranking" class="article_list">
...
<div id="paginate" class="ranking">
{if !is_null($form.nextPageNo)}
<a href="javascript:void(0);" data-page_no="2" onclick="ga('send', 'event', 'sp/検索', 'ページング', 'ランキング');">
